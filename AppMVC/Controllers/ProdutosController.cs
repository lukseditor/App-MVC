...
namespace AppMVC.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        {
            var context = _context.CategoriasProdutos.Include(p => p.Categoria);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var produto = await _context.CategoriasProdutos
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var produto = await _context.CategoriasProdutos.FindAsync(id);
            if (produto == null)
            {
                return NotFound();
            }
        ...
        {
            var produto = await _context.CategoriasProdutos.FindAsync(id);
            _context.CategoriasProdutos.Remove(produto);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
